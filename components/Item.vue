<template>
  <v-card
    ...
    class="my-4 pa-2"
    :to="
      `/restaurant/${$route.params.handle}/${$route.params.menu}/item/${itemId}`
    "
  >
    <h3 style="width:250px" class="body-1 font-weight-bold text-capitalize">
      {{ index + 1 }}. {{ title }}
    </h3>
